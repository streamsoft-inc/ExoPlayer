  ...
  protected void buildAudioRenderers(
    ...
    try {
     ...
     try {
      ...
      //-----------------------------------------------------------------//
      // IA decoder impl
      // Defined MpeghAudioRenderer instanitiation.
      Class<?> clazz =
              Class.forName("com.google.android.exoplayer2.ext.mpeghaudio.MpeghAudioRenderer");
      Constructor<?> constructor =
              clazz.getConstructor(
                      android.os.Handler.class,
                      com.google.android.exoplayer2.audio.AudioRendererEventListener.class,
      ...
      String appRootPath = context.getFilesDir().getParent();
      Renderer renderer =
              (Renderer) constructor.newInstance(eventHandler, eventListener,
                      appRootPath, true);
      out.add(extensionRendererIndex++, renderer);
