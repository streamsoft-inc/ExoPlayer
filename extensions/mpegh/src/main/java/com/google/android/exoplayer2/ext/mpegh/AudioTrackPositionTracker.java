...
/* package */ final class AudioTrackPositionTracker {
   ...
   * Notifies {@link AudioTrackPositionTracker.Listener#onUnderrun(int, long)} if the track has underrun.
   *
  ...
  public boolean mayHandleBuffer(long writtenFrames) {
    @AudioTrackPositionTracker.PlayState int playState = Assertions.checkNotNull(audioTrack).getPlayState();
