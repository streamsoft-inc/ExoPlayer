...
public class MpeghUtil {
     ...
     *                   Manifest.permission#READ_EXTERNAL_STORAGE} to read.
     * @return Whether a permission request was made.
     */
    ...
    public static @PolyNull String normalizeLanguageCode(@PolyNull String language) {
        ...
        normalizedTag = com.google.android.exoplayer2.util.Util.toLowerInvariant(normalizedTag);
        String mainLanguage = com.google.android.exoplayer2.util.Util.splitAtFirst(normalizedTag, "-")[0];
    ...
    String getCodecsOfType(@Nullable String codecs, int trackType) {
    ...
    /**
     * Hidden APIs defined in AudioFormat from Android S.
     *
     */
    private static final int CHANNEL_OUT_TOP_FRONT_LEFT = 0x4000;
    private static final int CHANNEL_OUT_TOP_FRONT_CENTER = 0x8000;
    private static final int CHANNEL_OUT_TOP_FRONT_RIGHT = 0x10000;
    private static final int CHANNEL_OUT_TOP_BACK_LEFT = 0x20000;
    private static final int CHANNEL_OUT_TOP_BACK_RIGHT = 0x80000;
    private static final int CHANNEL_OUT_BOTTOM_FRONT_LEFT = 0x400000;
    private static final int CHANNEL_OUT_BOTTOM_FRONT_CENTER = 0x800000;
    private static final int CHANNEL_OUT_BOTTOM_FRONT_RIGHT = 0x1000000;
    private static int CHANNEL_OUT_13POINT_360RA = (
            +AudioFormat.CHANNEL_OUT_FRONT_LEFT | AudioFormat.CHANNEL_OUT_FRONT_CENTER |
        ...
        switch (channelCount) {
            ...
            case 13:
                if (com.google.android.exoplayer2.util.Util.SDK_INT >= 31) {
                    return CHANNEL_OUT_13POINT_360RA;
                } else {
                    // 360RA channel configuration is not supported before Android S.
                    return AudioFormat.CHANNEL_INVALID;
                }
            default:
                return AudioFormat.CHANNEL_INVALID;
    ...
    /**
     * Makes a best guess to infer the {@link C.ContentType} from a {@link Uri}.
     *
    ...
    /**
     * Makes a best guess to infer the {@link C.ContentType} from a file name.
     *
    ...
    /**
     * Makes a best guess to infer the {@link C.ContentType} from a {@link Uri} and optional MIME type.
     *
     * @param uri      The {@link Uri}.
    ...
    public static int inferContentTypeForUriAndMimeType(Uri uri, @Nullable String mimeType) {
        if (mimeType == null) {
            return com.google.android.exoplayer2.util.Util.inferContentType(uri);
        }
        switch (mimeType) {
    ...
    /**
     * Returns the MIME type corresponding to the given adaptive {@link C.ContentType}, or {@code null}
    ...
    public static Point getCurrentDisplayModeSize(Context context, Display display) {
        if (com.google.android.exoplayer2.util.Util.SDK_INT <= 29 && display.getDisplayId() == Display.DEFAULT_DISPLAY && isTv(context)) {
            ...
            if ("Sony".equals(com.google.android.exoplayer2.util.Util.MANUFACTURER)
                    && com.google.android.exoplayer2.util.Util.MODEL.startsWith("BRAVIA")
            ...
            String displaySize =
                    com.google.android.exoplayer2.util.Util.SDK_INT < 28
    ...
    private static String[] getSystemLocalesV24(Configuration config) {
        return com.google.android.exoplayer2.util.Util.split(config.getLocales().toLanguageTags(), ",");
    }
