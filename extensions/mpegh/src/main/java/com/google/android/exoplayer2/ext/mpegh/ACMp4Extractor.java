 ...
 */
public final class ACMp4Extractor implements Extractor, SeekMap {

    public static final ExtractorsFactory FACTORY = () -> new Extractor[] {new ACMp4Extractor()};
     ...
     */
    public ACMp4Extractor(@Flags int flags) {
        this.flags = flags;
