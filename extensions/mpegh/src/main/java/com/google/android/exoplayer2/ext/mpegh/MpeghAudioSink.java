...
public final class MpeghAudioSink implements AudioSink {
  ...
  public void configure(
    ...
    AudioProcessor[] availableAudioProcessors = toIntPcmAvailableAudioProcessors;
  ...
  private void initialize() throws InitializationException {
    ...
    applyPlaybackParameters(playbackParameters, 0, false);
  ...
  public boolean handleBuffer(ByteBuffer buffer, long presentationTimeUs)
    ...
    if (pendingConfiguration != null) {
      ...
      applyPlaybackParameters(playbackParameters, presentationTimeUs, true);
    }
    ...
    if (inputBuffer == null) {
      ...
      if (afterDrainPlaybackParameters != null) {
        ...
        applyPlaybackParameters(newPlaybackParameters, presentationTimeUs, false);
      }
  ...
  private void applyPlaybackParameters(
      PlaybackParameters playbackParameters, long presentationTimeUs, boolean isPseudoFlash) {
    ...
    setupAudioProcessors(isPseudoFlash);
  }
