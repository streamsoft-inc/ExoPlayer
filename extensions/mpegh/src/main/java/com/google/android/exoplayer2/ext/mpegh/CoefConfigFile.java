...
/**
 * CoefConfigFile A class managing config files for passing
...
public class CoefConfigFile {
  static private String TAG = "CoefConfigFile";
   ...
   */
  public CoefConfigFile(String appRootpath) {
